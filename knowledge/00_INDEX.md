...
- Review writing craft (sentence discipline, per-concern micro-pattern, AI-tell/humanize pass, anonymity in prose): lives only in 06_WRITING_CRAFT.md.
...
- Deliverables per review: `output/Peer-Review-Report.docx` (referee report, author-and-editor facing) and `output/Editor-Summary.docx` (editor-only), both in the Psynalytics house report style; full report, meta-synthesis and evidence ledger (.md, stay in the project folder as the audit trail). The report is anonymous (signed "The Reviewer", no reviewer identity in either document) and follows the seven-part structure: Brief overview, Overall recommendation, Executive summary, Developmental feedback, Rubric scores, What would change my recommendation, Closing. The house-style docx look (A4, clean letterhead first page with a teal title block and metadata table, no full-bleed cover, letterhead background on every page, Gadugi headings, Calibri Light body, teal palette, banner section headers, teal-header tables) lives only in 05_REVIEW_TEMPLATES.md; it is produced by `.claude/skills/review-paper/assets/house-docx-generator.js`. Every author-facing and editor-facing sentence passes the 06 humanize pass before shipping. The narrative target for the report body is roughly 2000 to 3000 words; the word count is guidance, not a gate.
